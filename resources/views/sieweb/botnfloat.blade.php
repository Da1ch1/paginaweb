...
<link href="widget-contacto.css" rel="stylesheet">
<div class="wh-widget-send-button-desktop">
  <div class="wh-widget-send-button-wrapper wh-widget-left">
...
<!--/Boton de instagram-->
      ...
      <a class="wh-widget-button wh-widget-button-activator" href="javascript:void(0);">
        <div class="wh-widget-button-icon wh-messenger-bg-activator" style="background-color:#000000;">
          <div>
...
<script src="{{ asset('material') }}/js/botonfloat.js"></script>